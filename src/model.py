...
def train_eval(
  ...
  with tf.compat.v2.summary.record_if(
    ...
    if fc_conv_layer_params is not None:
      preprocessing_layers = tf.keras.layers.Lambda(lambda x: tf.expand_dims(x, -1))
    else:
    ...
    if train_sequence_length > 1:
      q_net = q_rnn_network.QRnnNetwork(
          ...
          conv_layer_params=fc_conv_layer_params,
